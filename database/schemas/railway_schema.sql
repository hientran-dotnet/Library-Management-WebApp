...
CREATE DATABASE IF NOT EXISTS railway_library_management;
USE railway_library_management;
...
-- Update statistics
UPDATE books SET UpdatedAt = CURRENT_TIMESTAMP WHERE Status = 'active';
